...
public class Constants {
	...
	public static List<String> PremiumCurrencyCode = Arrays.asList("CANADIAN DOLLAR (CAD)","EURO-BANKING ONLY (EUR)",
			...
			"GUATEMALAN QUETZAL (GTQ)","HONG KONG DOLLARS (HKD)","HUNGARIAN FORINT (HUF)","Icelandic Króna (ISK)",
			...
			"PAPUA NEW GUINEAN KINA (PGK)","Paraguayan Guaraní (PYG)","Peruvian Sol (PEN)","PHILIPPINES PESO (PHP)",
			...
			"UNIDADES DE FORMENTO (CLF)","Venezuelan Bolívar Fuerte (VEF)","VENEZUELAN BOLIVARS (VEB)","VIETNAMESE DONG (VND)",
